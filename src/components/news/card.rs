    ...
    html! {
        <a class="news-card-container row expand-x fade-in" href={props.article.url.clone()} target="_blank">
            <div class="col expand-x">
                ...
                <div class="news-card-details row flex-end-y">
                    <span>{format!("{} ( {} )", &props.article.author, &props.article.source)}</span>
                    <span class="flex-end-x">{&props.article.published_at.split_once("T").unwrap().0}</span>
                </div>
            </div>
            <div class="col">
                <img class="" src={format!("{}", if !props.article.image.is_empty() {props.article.image.clone()} else {"imgs/bubble-favicon.png".to_string()})} />
                if props.saved.is_none(){
                    <div class="row flex-end-y">
                        <button class="news-card-button" name="like" onclick={&on_click_action}>
                            <svg id={"like"} class="news-card-svg" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                                <path id={"like"} d="M14.8285 14.8284L16.2427 13.4142L12.0001 9.17161L7.75745 13.4142L9.17166 14.8285L12.0001 12L14.8285 14.8284Z"/>
                                <path id={"like"} fill-rule="evenodd" clip-rule="evenodd" d="M1 19C1 21.2091 2.79086 23 5 23H19C21.2091 23 23 21.2091 23 19V5C23 2.79086 21.2091 1 19 1H5C2.79086 1 1 2.79086 1 5V19ZM5 21H19C20.1046 21 21 20.1046 21 19V5C21 3.89543 20.1046 3 19 3H5C3.89543 3 3 3.89543 3 5V19C3 20.1046 3.89543 21 5 21Z"/>
                            </svg>
                        </button>
                        <button class="news-card-button" name="dislike" onclick={&on_click_action}>
                            <svg id={"dislike"} class="news-card-svg" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                                <path id={"dislike"} d="M7.75739 10.5858L9.1716 9.17154L12 12L14.8284 9.17157L16.2426 10.5858L12 14.8284L7.75739 10.5858Z" />
                                <path id={"dislike"} fill-rule="evenodd" clip-rule="evenodd" d="M1 5C1 2.79086 2.79086 1 5 1H19C21.2091 1 23 2.79086 23 5V19C23 21.2091 21.2091 23 19 23H5C2.79086 23 1 21.2091 1 19V5ZM5 3H19C20.1046 3 21 3.89543 21 5V19C21 20.1046 20.1046 21 19 21H5C3.89543 21 3 20.1046 3 19V5C3 3.89543 3.89543 3 5 3Z" />
                            </svg>
                        </button>
                        <button class="news-card-button" name="save" onclick={&on_click_action}>
                            <svg id={"save"} class="news-card-svg"  xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                                <path id={"save"} d="M11 14.5V16.5H13V14.5H15V12.5H13V10.5H11V12.5H9V14.5H11Z" />
                    ...
                    <div class="row flex-end-y">
                        <button class="news-card-button" name="delete" onclick={&on_click_action}>
                            <svg id={"delete"} class="news-card-svg" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                                <path id={"delete"} d="M9 14.5V12.5H15V14.5H9Z" />
