...
**This frontend is made fully in Rust, using the Yew Rust crate for most of the frontend logic. It is hosted in Azure via a docker container. (Demo can be requested)**
